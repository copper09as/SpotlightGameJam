...
public static class MLAgentsInferenceAutomation
{
    ...
    {
        BuildInferenceScene("Assets/Scenes/LEVELTEST01.unity", "Builds/MLInference/LEVELTEST01_FinalPass/SpotlightTraining.exe", "Assets/ML-Agents/Models/My Behavior_FinalPass.onnx");
    }

    public static void BuildFinalPassLevel02()
    {
        BuildInferenceScene("Assets/Scenes/LEVELTEST02.unity", "Builds/MLInference/LEVELTEST02_FinalPass/SpotlightTraining.exe", "Assets/ML-Agents/Models/My Behavior_FinalPass.onnx");
    }

    public static void BuildFinalPassLevel03()
    {
        BuildInferenceScene("Assets/Scenes/LEVELTEST03.unity", "Builds/MLInference/LEVELTEST03_FinalPass/SpotlightTraining.exe", "Assets/ML-Agents/Models/My Behavior_FinalPass.onnx");
    }
