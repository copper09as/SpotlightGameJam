...
namespace XLua.CSObjectWrap
{
    ...
    public class ToolWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "GetColliderWidth", _m_GetColliderWidth_xlua_st_);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetColliderWidth_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    UnityEngine.Collider2D _collider = (UnityEngine.Collider2D)translator.GetObject(L, 1, typeof(UnityEngine.Collider2D));
                        ...
                        var gen_ret = Tool.GetColliderWidth( _collider );
