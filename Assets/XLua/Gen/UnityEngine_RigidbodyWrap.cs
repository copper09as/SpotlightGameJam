...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineRigidbodyWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetAccumulatedForce", _m_GetAccumulatedForce);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetAccumulatedTorque", _m_GetAccumulatedTorque);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "automaticCenterOfMass", _g_get_automaticCenterOfMass);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "automaticInertiaTensor", _g_get_automaticInertiaTensor);
            ...
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "automaticCenterOfMass", _s_set_automaticCenterOfMass);
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "centerOfMass", _s_set_centerOfMass);
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "automaticInertiaTensor", _s_set_automaticInertiaTensor);
        ...
        static int _m_Move(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.Move( _position, _rotation );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetAccumulatedForce(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 1) 
                {
                        ...
                        var gen_ret = gen_to_be_invoked.GetAccumulatedForce(  );
                        translator.PushUnityEngineVector3(L, gen_ret);
                ...
                if(gen_param_count == 2&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)) 
                {
                    float _step = (float)LuaAPI.lua_tonumber(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.GetAccumulatedForce( _step );
                        translator.PushUnityEngineVector3(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Rigidbody.GetAccumulatedForce!");
            
        }
        
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetAccumulatedTorque(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 1) 
                {
                        ...
                        var gen_ret = gen_to_be_invoked.GetAccumulatedTorque(  );
                        translator.PushUnityEngineVector3(L, gen_ret);
                ...
                if(gen_param_count == 2&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)) 
                {
                    float _step = (float)LuaAPI.lua_tonumber(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.GetAccumulatedTorque( _step );
                        translator.PushUnityEngineVector3(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Rigidbody.GetAccumulatedTorque!");
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_automaticCenterOfMass(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                UnityEngine.Rigidbody gen_to_be_invoked = (UnityEngine.Rigidbody)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushboolean(L, gen_to_be_invoked.automaticCenterOfMass);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_automaticInertiaTensor(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                UnityEngine.Rigidbody gen_to_be_invoked = (UnityEngine.Rigidbody)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushboolean(L, gen_to_be_invoked.automaticInertiaTensor);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_automaticCenterOfMass(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                UnityEngine.Rigidbody gen_to_be_invoked = (UnityEngine.Rigidbody)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.automaticCenterOfMass = LuaAPI.lua_toboolean(L, 2);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_automaticInertiaTensor(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                UnityEngine.Rigidbody gen_to_be_invoked = (UnityEngine.Rigidbody)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.automaticInertiaTensor = LuaAPI.lua_toboolean(L, 2);
