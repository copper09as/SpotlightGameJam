    ...
    public class DetectionManagerWrap 
    {
        ...
        static int _m_Raycast2D_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 4&& translator.Assignable<UnityEngine.Vector2>(L, 1)&& translator.Assignable<UnityEngine.Vector2>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& (LuaAPI.lua_isnil(L, 4) || LuaAPI.lua_type(L, 4) == LuaTypes.LUA_TSTRING)) 
                {
                ...
                if(gen_param_count == 4&& translator.Assignable<UnityEngine.Vector2>(L, 1)&& translator.Assignable<UnityEngine.Vector2>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& (LuaAPI.lua_isnil(L, 4) || LuaAPI.lua_type(L, 4) == LuaTypes.LUA_TSTRING)) 
                {
                    ...
                    UnityEngine.RaycastHit2D _hitInfo;
                        ...
                        var gen_ret = DetectionManager.Raycast2D( _origin, _direction, _distance, _layerMask, out _hitInfo );
                        LuaAPI.lua_pushboolean(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DetectionManager.Raycast2D!");
        ...
        static int _m_CircleCast_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 3&& translator.Assignable<UnityEngine.Vector2>(L, 1)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& translator.Assignable<UnityEngine.LayerMask>(L, 3)) 
                {
                    UnityEngine.Vector2 _center;translator.Get(L, 1, out _center);
                ...
                if(gen_param_count == 3&& translator.Assignable<UnityEngine.Vector2>(L, 1)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& translator.Assignable<UnityEngine.LayerMask>(L, 3)) 
                {
                    ...
                    UnityEngine.Collider2D _hit;
                        ...
                        var gen_ret = DetectionManager.CircleCast( _center, _radius, _layerMask, out _hit );
                        LuaAPI.lua_pushboolean(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to DetectionManager.CircleCast!");
