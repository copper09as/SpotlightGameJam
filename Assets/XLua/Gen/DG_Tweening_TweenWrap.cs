...
namespace XLua.CSObjectWrap
{
    ...
    public class DGTweeningTweenWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "IsTimeScaleIndependent", _m_IsTimeScaleIndependent);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_IsTimeScaleIndependent(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = gen_to_be_invoked.IsTimeScaleIndependent(  );
                        LuaAPI.lua_pushboolean(L, gen_ret);
