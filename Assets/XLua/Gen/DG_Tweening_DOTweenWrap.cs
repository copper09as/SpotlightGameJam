...
namespace XLua.CSObjectWrap
{
    ...
    public class DGTweeningDOTweenWrap 
    {
        public static void __Register(RealStatePtr L)
        {
		    ...
		    Utils.BeginClassRegister(type, L, __CreateInstance, 49, 25, 25);
            ...
            Utils.RegisterFunc(L, Utils.CLS_GETTER_IDX, "tweenersCapacity", _g_get_tweenersCapacity);
            Utils.RegisterFunc(L, Utils.CLS_GETTER_IDX, "sequencesCapacity", _g_get_sequencesCapacity);
            ...
            Utils.RegisterFunc(L, Utils.CLS_SETTER_IDX, "tweenersCapacity", _s_set_tweenersCapacity);
            Utils.RegisterFunc(L, Utils.CLS_SETTER_IDX, "sequencesCapacity", _s_set_sequencesCapacity);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_tweenersCapacity(RealStatePtr L)
        {
		    try {
            
			    LuaAPI.xlua_pushinteger(L, DG.Tweening.DOTween.tweenersCapacity);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_sequencesCapacity(RealStatePtr L)
        {
		    try {
            
			    LuaAPI.xlua_pushinteger(L, DG.Tweening.DOTween.sequencesCapacity);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_tweenersCapacity(RealStatePtr L)
        {
		    try {
                
			    DG.Tweening.DOTween.tweenersCapacity = LuaAPI.xlua_tointeger(L, 1);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_sequencesCapacity(RealStatePtr L)
        {
		    try {
                
			    DG.Tweening.DOTween.sequencesCapacity = LuaAPI.xlua_tointeger(L, 1);
